...
const httpGet = async (endpoint: string, options?: ApiRequestOptions) => {
  try {
    const response = await axiousInstance().get(endpoint, {
...
const httpPost = async (
  ...
  try {
    const response = await axiousInstance().post(endpoint, data, {
      params: options?.params,
      headers: options?.headers,
    });
...
const httpPut = async (
  ...
  try {
    const response = await axiousInstance().put(endpoint, data, {
      params: options?.params,
      headers: options?.headers,
    });
...
const httpPatch = async (
  ...
  try {
    const response = await axiousInstance().patch(endpoint, data, {
      params: options?.params,
      headers: options?.headers,
    });
...
const httpDelete = async (endpoint: string, options?: ApiRequestOptions) => {
  try {
    const response = await axiousInstance().delete(endpoint, {
      params: options?.params,
      headers: options?.headers,
    });
